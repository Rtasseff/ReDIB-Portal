    ...
    def create_applications(self, users, calls, equipment):
        ...
        apps['completed'], created = Application.objects.get_or_create(
            ...
            defaults={
                ...
                # Applicant details (snapshot at submission)
                'applicant_name': 'Alice Researcher',
                'applicant_entity': 'Universidad de Pruebas',
        ...
        apps['rejected'], created = Application.objects.get_or_create(
            ...
            defaults={
                ...
                # Applicant details (snapshot at submission)
                'applicant_name': 'Bob Scientist',
                'applicant_entity': 'External Research Institute',
