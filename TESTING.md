...
The ReDIB COA Portal has completed all 10 development phases and is now in the **comprehensive testing phase**. This guide is being actively expanded with detailed testing procedures, edge cases, and exploratory testing scenarios beyond the initial automated test walkthrough.
