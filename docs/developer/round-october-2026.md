...
- **#27** (CallForm status guard) — earlier still: before the 09-15 announce,
  since announcing is done through that form.
...
| # | Slug | Items | Cut from | Merge by | In prod by | Model | Review |
|---|---|---|---|---|---|---|---|
| 1 | `baseline` | 7, 8, 31 | `main` now | 2026-08-21 | 2026-08-22 | Sonnet | diff read + suite |
| 2 | `call-hardening` | 27, 33, 13-min, 9 | `main` now | 2026-09-08 | **#27 by 09-12**, rest by 10-13 | Sonnet | targeted read + suite |
| 3 | `closeout` | 29, 30, 36, 17, 28 (35 stretch) | `main` after #1 | 2026-09-11 | 2026-09-15 | Sonnet | `/code-review` medium |
| 4 | `eval-reminders` | 32, 5 | `main` after #3 | 2026-10-09 | 2026-10-13 (else before evaluator assignments, ~12) | Sonnet | `/code-review` medium |
| 5 | `release-gate` | 15 (16 stretch) | `main` after #2 | **2026-12-05 (abort date)** | before the first evaluation completes | Opus | `/code-review` medium |
| 6 | `resolution-report` | 20 | `main` after #4 | 2027-01-15 | before results are published | Sonnet | targeted read + suite |
...
|---|---|---|---|---|
| `baseline` | 2026-08-18 | | | |
| `call-hardening` | 2026-08-18 | | | #27 must be in prod before the 09-15 announce |
